...
// Native tokens for all supported chains
...
// Stablecoin tokens by chain - All supported chains
...
// Helper function to get only bridge-supported chain IDs
export const getBridgeSupportedChainIds = (): number[] => {
  return Object.keys(BRIDGE_TOKENS).map(Number)
}
